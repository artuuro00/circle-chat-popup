...
const ContentArea = () => {
  return (
    <div className="content-area">
      <div className="content-card bg-[#222222] mb-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-medium text-white border-b-0">Econometría</h2>
          <div className="flex space-x-2">
            <button className="bg-[#333333] text-white px-3 py-1 rounded-md text-sm flex items-center gap-1">
              <Link2 size={14} />
              <span>Enlace</span>
            </button>
            <button className="bg-[#333333] text-white px-2 py-1 rounded-md flex items-center">
              <Maximize size={14} />
            </button>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-4 md:w-1/3">
        <div className="content-card bg-[#222222]">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-medium text-white border-b-0">Anuncios recientes</h2>
            <div className="bg-[#333333] text-white px-3 py-1 rounded-md text-sm flex items-center gap-1">
              <Link2 size={14} />
              <span>Enlace</span>
            </div>
          </div>

          <div className="bg-[#333333] inline-block px-2 py-1 rounded mb-2 text-sm">
            Opciones
          </div>
          ...
          <p className="text-gray-300 mb-1">Actualmente, no hay anuncios en esta ubicación.</p>
        </div>

        <div className="content-card bg-[#222222]">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-medium text-white border-b-0">Mensajes de chat recientes</h2>
            <div className="bg-[#333333] text-white px-3 py-1 rounded-md text-sm flex items-center gap-1">
              <Link2 size={14} />
              <span>Enlace</span>
            </div>
        ...
        <div className="content-card bg-[#222222]">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-medium text-white border-b-0">Calendario</h2>
            <div className="bg-[#333333] text-white px-3 py-1 rounded-md text-sm flex items-center gap-1">
              <Link2 size={14} />
              <span>Enlace</span>
            </div>
          ...
          <div className="flex space-x-2 mb-4">
            <div className="bg-[#333333] inline-block px-2 py-1 rounded text-sm">
              Opciones
            </div>
            <div className="bg-[#333333] inline-block px-2 py-1 rounded text-sm">
              Publicar (privado)
